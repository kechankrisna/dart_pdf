              ...
              pw.Align(
                ...
                child: pw.UrlLink(
                  ...
                  child: pw.Text(
                    ...
                    style: const pw.TextStyle(color: PdfColors.pink100),
                  ),
                ),
              ),
            ],
  ...
  doc.addPage(
    pw.MultiPage(
      ...
      build: (pw.Context context) => <pw.Widget>[
        ...
        pw.Bullet(
          text: 'Raster graphics for photographs and other types of image',
        ),
        ...
        pw.Header(level: 1, text: 'File formats and Adobe Acrobat versions'),
        pw.Paragraph(
          text:
