      ...
      for (var angle = 0.0; angle < math.pi * 2; angle += step) {
        ...
        switch (colorSpace) {
          case ColorSpace.rgb:
            ...
            break;
          case ColorSpace.ryb:
            context.canvas.setFillColor(
              PdfColor.fromRYB(ic.red, ic.green, ic.blue),
            );
            break;
          case ColorSpace.cmy:
            context.canvas.setFillColor(
              PdfColorCmyk(ic.red, ic.green, ic.blue, 0),
            );
            break;
        }
        ...
        build: (Context context) => <Widget>[
          ...
          GridView(
            ...
            children: <Widget>[
              ...
              Color(PdfColors.deepPurpleAccent100, 'Deep Purple', 'Accent 100'),
              Color(PdfColors.deepPurpleAccent200, 'Deep Purple', 'Accent 200'),
              Color(PdfColors.deepPurpleAccent400, 'Deep Purple', 'Accent 400'),
              Color(PdfColors.deepPurpleAccent700, 'Deep Purple', 'Accent 700'),
            ],
          ),
          NewPage(),
          ...
          GridView(
            ...
            children: <Widget>[
              ...
              Color(PdfColors.lightBlueAccent100, 'Light Blue', 'Accent 100'),
              Color(PdfColors.lightBlueAccent200, 'Light Blue', 'Accent 200'),
              Color(PdfColors.lightBlueAccent400, 'Light Blue', 'Accent 400'),
              Color(PdfColors.lightBlueAccent700, 'Light Blue', 'Accent 700'),
            ],
          ),
          NewPage(),
          ...
          GridView(
            ...
            children: <Widget>[
              ...
              Color(PdfColors.lightGreenAccent100, 'Light Green', 'Accent100'),
              Color(PdfColors.lightGreenAccent200, 'Light Green', 'Accent200'),
              Color(PdfColors.lightGreenAccent400, 'Light Green', 'Accent400'),
              Color(PdfColors.lightGreenAccent700, 'Light Green', 'Accent700'),
            ],
          ),
          NewPage(),
          ...
          GridView(
            ...
            children: <Widget>[
              ...
              Color(PdfColors.deepOrangeAccent100, 'Deep Orange', 'Accent 100'),
              Color(PdfColors.deepOrangeAccent200, 'Deep Orange', 'Accent 200'),
              Color(PdfColors.deepOrangeAccent400, 'Deep Orange', 'Accent 400'),
              Color(PdfColors.deepOrangeAccent700, 'Deep Orange', 'Accent 700'),
            ],
          ),
          NewPage(),
          ...
          build: (Context context) => Column(
            children: <Widget>[
              ...
              SizedBox(
                ...
                child: ColorWheel(colorSpace: colorSpace),
              ),
            ],
          ),
        ),
