            ...
            Expanded(
              child: FittedBox(
                child: Transform.rotateBox(
                  angle: 0.2,
                  child: Text('Expanded', tightBounds: true),
                ),
              ),
            ),
            Container(
              ...
              child: Text(
                ...
                style: Theme.of(
                  context,
                ).defaultTextStyle.copyWith(font: Font.timesBoldItalic()),
                textScaleFactor: 3,
              ),
            ),
          ],
        ...
        build: (Context context) => Center(
          child: GridView(
            ...
            children: List<Widget>.generate(
              9,
              (int n) => FittedBox(child: Text('${n + 1}', tightBounds: true)),
            ),
          ),
        ),
      ),
        ...
        build: (Context context) => <Widget>[
          TableHelper.fromTextArray(
            ...
            data: <List<String>>[
              ...
              <String>['Spaceage Stereo', 'Igor Cavalcanti Pereira', 'Brasil'],
